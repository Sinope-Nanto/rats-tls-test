...
typedef struct rtls_demo_evidence {
	uint8_t *vm_id;
	uint32_t vm_id_sz;
	uint8_t *vm_version;
	uint32_t vm_version_sz;
...
#define RATS_TLS_CONF_FLAGS_GLOBAL_MASK	       ((1UL << RATS_TLS_CONF_FLAGS_PRIVATE_MASK_SHIFT) - 1)
#define RATS_TLS_CONF_FLAGS_PRIVATE_MASK       (~RATS_TLS_CONF_FLAGS_GLOBAL_MASK)
